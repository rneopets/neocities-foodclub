...
function calc_maxter() {
    if (vm.maxBet <= 0) {
        alert("Please input a Max Personal Bet value greater than 0 (located at the bottom of the table).");
        return;
    }
    //vm = window.vm;
    maxbet = vm.maxBet;
    ...
    window.location = window.location.href + "#round=" + parseInt(vm.round) + "&b=" + linkCode;
}
